...
<div class="overflow-hidden" on:mousemove={mousemove}>
  ...
  <span class="fixed animate-pulse w-[100vw] h-[100vh] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] -z-10 select-none pointer-events-none text-xl text-[#b6a2ff15]">
